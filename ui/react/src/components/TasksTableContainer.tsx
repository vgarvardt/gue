...
function TasksTableContainer(props: Props & ReduxProps) {
  ...
  const chips = [
    ...
    {key: "failed", label: "Failed", count: currentStats.retry},
    ...
    <Paper variant="outlined" className={classes.container}>
      ...
      <TabPanel value="pending" selected={props.selected}>
        <ActiveTasksTable
          ...
          queryRequest={"pending_tasks"}
        />
      </TabPanel>
      <TabPanel value="failed" selected={props.selected}>
        <ActiveTasksTable
          queue={props.queue}
          totalTaskCount={currentStats.retry}
          queryRequest={"fail_tasks"}
        />
      </TabPanel>
